-- Seed current SISI menu -> Dotypos product mappings.
-- These rows make POS mapping deterministic instead of relying on fuzzy names.
...
-- 27/28/30/35/42/43 are disabled drinks whose names/prices do not match
-- a safe POS product in the current export.
-- 45 Halloween Burger has no distinct POS product in the current export.
