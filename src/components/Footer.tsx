...
import { ShoppingCart, Phone, Facebook, Instagram, Twitter, Mail } from "lucide-react";
  ...
  return (
    <footer className="bg-black text-white py-12">
      ...
      <div className="mt-12 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
        © {new Date().getFullYear()} SiSi Ordering. Wszelkie prawa zastrzeżone.
        Stronę i system wykonał Karol Wyszczelski.
      </div>
    </footer>
  );
}
