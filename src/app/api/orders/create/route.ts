...
function normalizeBody(raw: any, req: Request) {
  ...
  return {
    ...
    ...(() => {
      const ct = normalizeClientTime(base?.client_delivery_time ?? base?.delivery_time ?? null);
      return {
        client_delivery_time: ct.client_delivery_time,
        delivery_time: ct.delivery_time,
      };
    })(),
    eta: base?.eta ?? null,
