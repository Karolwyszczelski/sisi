...
export default function RegulaminPage() {
  return (
    <LegalPageLayout title="Regulamin" icon="terms">
      ...
      <div className="bg-yellow-400/10 border border-yellow-400/20 rounded-xl p-4 mb-8">
        <p className="text-sm text-yellow-400/90 !m-0">
          Operatorem Serwisu i Sprzedawcą jest <strong>{LEGAL.legalName}</strong>, NIP {LEGAL.nip}, REGON {LEGAL.regon}
          {LEGAL.krs ? <>, KRS {LEGAL.krs}</> : null}, z adresem rejestrowym: {LEGAL.registeredAddress}, 
          lokal gastronomiczny: {LEGAL.restaurantAddress}.
        </p>
      </div>

      <h2>§1. Definicje</h2>
      <ul>
        <li><strong>Serwis</strong> – strona/aplikacja internetowa umożliwiająca składanie zamówień.</li>
        <li><strong>Sprzedawca/Operator</strong> – {LEGAL.legalName}.</li>
        <li><strong>Klient</strong> – konsument lub przedsiębiorca składający zamówienie.</li>
        <li><strong>Zamówienie</strong> – oświadczenie woli Klienta, zmierzające do zawarcia umowy sprzedaży.</li>
        <li><strong>Umowa</strong> – umowa sprzedaży posiłków/napojów zawierana na odległość za pośrednictwem Serwisu.</li>
        <li><strong>Płatność online</strong> – obsługiwana przez zewnętrznego operatora płatności (np. Przelewy24/PayPro S.A.).</li>
      </ul>
      ...
      <p>
        ...
        <a href="/cookies">Polityką cookies</a>.
      </p>
